...
const INITIAL_RECORDS: SMSReportRecord[] = [
  ...
  },
  {
    ...
    mobile: '9765432189',
    message: 'Alert: Your Equity Premier advisory service expires in 4 days. Renew today: stoketics.in/renew',
    sender: 'STKCRM',
  ...
  },
  {
    sNo: 6,
    id: 'sms-106',
    ownerName: 'Sunil Mittal (Nivesh Cap)',
    mobile: '9811120981',
